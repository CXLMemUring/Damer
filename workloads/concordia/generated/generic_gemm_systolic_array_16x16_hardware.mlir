module attributes {
  ...
  concordia.rtl_module = "sovryn_pan_stem_systolic_array_16x16",
  concordia.selected_ip = "systolic_array_16x16",
  concordia.wrapper = "gemma_codegen_systolic_array_16x16_df",
  concordia.flit_bytes = 64 : i64
} {
  hw.module @generic_gemm_systolic_array_16x16_hardware_path(in %host_cmd: i512,
